...
# Parameters
model_type='LEUP_uniform_onlattice'
...
model_parameters={'beta_list':beta_list,'R_list':R_list,'bias_param_list':bias_param_list,'speed_list':[0.1],'L_list':[15],\
                    'simulation_steps':1000,'eta':0,'No_of_particle':250,'no_of_trajectory':200}

simulator_onlattice(model_type,model_parameters,output_path)
